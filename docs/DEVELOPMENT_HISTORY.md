...
这种方案让 APK 很小、视觉高度可控，也避免了第三方 UI 依赖；代价是 `MainActivity` 已超过 1200 行，自动化 UI 测试、无障碍语义和后续多人维护会更困难。
...
- 当前 Java 源码约 5256 行，共 16 个主要类文件。
- `CityContentData.java` 约 1403 行，承担全国城市内容主体。
- `MainActivity.java` 约 1224 行，承担大部分界面和交互。
